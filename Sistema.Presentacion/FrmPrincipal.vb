...
Public Class FrmPrincipal
    ...
    Private Sub FrmPrincipal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TsBarraInferior.Text = "Desarrollado por CABRERA: " & Me.Nombre
        MsgBox("Bienvenido" & Me.Nombre, vbOKOnly + vbInformation, "Bienvenido al Sistema")

        'PERMISO DE ACCESO SEGUN ROL DE USUARIO
    ...
    Private Sub UsuariosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UsuariosToolStripMenuItem.Click
        'ABRE FORMULARIO USUARIOS
        Dim frm As New FrmUsuario
        frm.MdiParent = Me
        frm.Show()
    End Sub

    'METODO EVENTO SALIR DEL SISTEMA
    ...
    'METODO EVENTO SALIR DEL SISTEMA AL DARLE CLICK EN LA X
    Private Sub FrmPrincipal_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        End
    End Sub

    Private Sub ProveedoresToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ProveedoresToolStripMenuItem.Click
        'ABRE FORMULARIO PROVEEDOR
