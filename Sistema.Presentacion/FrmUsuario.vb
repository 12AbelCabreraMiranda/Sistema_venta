Public Class FrmUsuario
    'METODO CONFIGURACÍON ANCHO DE COLUMNAS
    Private Sub Formato()
    ...
    'METODO CARGA LOS ROLES EN COMBOBOX
    ...
    'METODO EVENTO BUSCAR
    Private Sub BtnBuscar_Click(sender As Object, e As EventArgs) Handles BtnBuscar.Click
        Me.Buscar()

    End Sub

    'METODO EVENTO INSERTAR DATOS
    ...
    'METODO EVENTO CANCELAR, REDIRECCIONA AL TAB LISTADO
    Private Sub BtnCancelar_Click(sender As Object, e As EventArgs) Handles BtnCancelar.Click
        Me.Limpiar()
        TabGeneral.SelectedIndex = 0
    End Sub

    'METODO EVENTO ACTUALIZAR DATOS
    ...
    Private Sub DgvListado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgvListado.CellDoubleClick
        Try
            ...
            BtnInsertar.Visible = False     'DESACTIVA BOTON INSERTAR
            BtnActualizar.Visible = True    'ACTIVA BOTON ACTUALIZAR
            TabGeneral.SelectedIndex = 1    'LLAMA AL TAB MANTENIMIENTO LLEVANDO LOS DATOS
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    'BOTON CHECK, ACTIVA Y DESACTIVA BOTONES
    ...
    'METODO EVENTO ELIMINAR DATOS SELECCIONADOS
    ...
    'METODO EVENTO ACTIVAR DATOS SELECCIONADOS
    ...
    'METODO EVENTO DESACTIVAR DATOS SELECCIONADOS
