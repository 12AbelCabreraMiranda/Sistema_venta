Public Class FrmVenta
    ...
    'METODO BUSCA CODIGO DE BARRA Y AGREGA A LA TABLA TEMPORAL
    ...
    Private Sub DgvDetalle_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles DgvDetalle.CellEndEdit
        ...
        If (Cantidad > Stock) Then
            Cantidad = Stock 'MODIFICA CELDA CANTIDAD IGUAL AL QUE TIENE STOCK, porque no se puede vender más de lo que tiene stock
    ...
    'METODO EVENTO QUE MUESTRA DETALLE DE CADA VENTA EN UN PANEL 
    ...
    Private Sub BtnAnular_Click(sender As Object, e As EventArgs) Handles BtnAnular.Click
        If (MsgBox("Estas seguro de Anular las ventas seleccionados?", vbYesNo + vbQuestion, "Anular Ingresos") = vbYes) Then
            Try
                Dim Neg As New Negocio.NVenta
