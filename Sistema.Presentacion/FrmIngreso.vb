Public Class FrmIngreso
    ...
    'FORMATO DE COLUMNAS PARA EL CUADRO DEL PANEL DE ARTICULOS
    ...
    Private Sub CrearTablaDetalle()
        'AGREGA COLUMNAS A DATAGRIDVIEW DETALLE, deben tener el mismo orden que el Type agregado en la base de datos.
        ...
        'OBTIENE LOS DATOS EN EL DGVDETALLE EXTRALLENDOLO DEL OBJETO DTDETALLE
    ...
    'METODO PARA AGREGAR LOS PRODUCTOS ENCONTRADOS O SELECCIONADOS MANDANDOLOS AL DATAGRIDVIEW DETALLE
    Private Sub AgregarDetalle(Fila As Entidades.Articulo)
        Dim Agregar As Boolean = True

        'NO AGREGA ARTICULOS REPETIDOS
        ...
        If (Agregar) Then
            ...
            'AL TENER LA FILA, SE PROCEDE AL AGREGARLO AL DETALLE
            Me.DtDetalle.Rows.Add(Row)
            Me.CalcularTotales()
        End If
    End Sub

    'METODO PARA REALIZAR LOS PROCEDIMIENTOS DE LOS CÁLCULOS
    ...
    Private Sub BtnBuscarProveedor_Click(sender As Object, e As EventArgs) Handles BtnBuscarProveedor.Click
        FrmProveedor_Ingreso.ShowDialog() ' CUANDO SE CIERRA, EJECUTA EL NEXT CODIGO 

        'GUARDAR EN LOS CAMPOS DE TEXTOS LOS DATOS QUE HAY ALMACENADOS EN LAS VARIABLES
        TxtIdProveedor.Text = Variables.IdProveedor
        TxtNombreProveedor.Text = Variables.NombreProveedor
    End Sub

    'METODO QUE REALIZA BUSQUEDA DE ARTICULOS SI EXISTE
    ...
    'METODO EVENTO MOSTRAR PANEL DE ARTICULOS
    Private Sub BtnBuscarArticulos_Click(sender As Object, e As EventArgs) Handles BtnBuscarArticulos.Click
        PanelArticulos.Visible = True
    End Sub

    'METODO EVENTO OCULTAR PANEL DE ARTICULOS
    Private Sub BtnCerrar_Click(sender As Object, e As EventArgs) Handles BtnCerrar.Click
        PanelArticulos.Visible = False
    End Sub

    'METODO EVENTO BUSCAR ARTICULOS DENTRO DEL CUADRO DEL PANEL
    Private Sub BtnBuscarArticulosDetalle_Click(sender As Object, e As EventArgs) Handles BtnBuscarArticulosDetalle.Click
        Try
            ...
            DgvArticulos.DataSource = Neg.Buscar(Valor) 'LLENA EL DATAGRIDVIEW CON LOS DATOS ENCONTRADOS
    ...
    Private Sub DgvDetalle_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles DgvDetalle.CellEndEdit
        'ACTUALIZA CELDAS QUE SE MODIFICAN
    ...
    Private Sub BtnInsertar_Click(sender As Object, e As EventArgs) Handles BtnInsertar.Click
        Try
            If (TxtIdProveedor.Text <> "" And CboTipoComprobante.Text <> "" And TxtNumComprobante.Text <> "" And DtDetalle.Rows.Count > 0) Then
                ...
                If (Neg.Insertar(Obj, DtDetalle)) Then  'SI ES TRUE ENTONCES INSERTA
    ...
    Private Sub DgvListado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgvListado.CellDoubleClick
        Try
            Dim Neg As New Negocio.NIngreso
            'SELE PASA EL PARAMETRO AL METODO: LISTARDETALLE, Item 1 es el id seleccionado en la celda
